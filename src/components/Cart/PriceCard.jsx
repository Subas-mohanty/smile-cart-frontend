...
export default memo(PriceCard); // memoizing the component, so that it will not re-render if the props have not changed, if only the parent component changed it will not run
